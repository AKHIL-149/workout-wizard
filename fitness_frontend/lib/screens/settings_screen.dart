...
import 'undulating_periodization_screen.dart';
                ...
                _buildSection(
                  ...
                  children: [
                    ...
                    _buildListTile(
                      ...
                      subtitle: 'Track your current training program',
                    ...
                    _buildListTile(
                      context,
                      title: 'Calendar Sync',
                      subtitle: 'Sync workouts to device calendar',
                      icon: Icons.calendar_today,
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const CalendarSyncScreen(),
                          ),
                        );
                      },
                    ),
                    ...
                    _buildListTile(
                      ...
                      subtitle: 'Advanced training blocks with auto-progression',
                      icon: Icons.view_timeline,
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const BlockPeriodizationScreen(),
                          ),
                        );
                      },
                    ),
                    ...
                    _buildListTile(
                      ...
                      subtitle: 'Daily/weekly variation in intensity and volume',
                      icon: Icons.waves,
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const UndulatingPeriodizationScreen(),
                          ),
                        );
                      },
                    ),
                    ...
                    _buildListTile(
                      ...
                      subtitle: 'Browse exercises with instructions',
