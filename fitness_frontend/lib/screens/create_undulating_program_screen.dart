...
/// Screen for creating undulating periodization programs
class CreateUndulatingProgramScreen extends StatefulWidget {
  final String templateType;

  const CreateUndulatingProgramScreen({
    super.key,
    required this.templateType,
  });

  @override
  State<CreateUndulatingProgramScreen> createState() =>
      _CreateUndulatingProgramScreenState();
}

class _CreateUndulatingProgramScreenState
    extends State<CreateUndulatingProgramScreen> {
  ...
  String _getDefaultName() {
    switch (widget.templateType) {
      case 'beginner':
        return 'Beginner DUP Program';
      case 'advanced':
        return 'Advanced DUP Program';
      case 'weekly':
        return 'Weekly Undulating Program';
      default:
        return 'Undulating Periodization Program';
    }
  }
  ...
  String _getDescription() {
    switch (widget.templateType) {
      case 'beginner':
        return '12-week beginner DUP with 3-day cycle (Heavy, Light, Moderate)';
      case 'advanced':
        return '8-week advanced DUP with 4-day cycle (Max Strength, Hypertrophy, Power, Recovery)';
      case 'weekly':
        return '10-week weekly undulating with Volume, Intensity, and Deload weeks';
      default:
        return 'Undulating periodization program';
    }
  }
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text(
              'Enter your current estimated or tested 1-rep max for each lift. The program will vary intensity and volume based on these values.',
              style: TextStyle(
                fontSize: 13,
                color: Colors.grey.shade600,
              ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'DUP varies intensity and volume frequently to:\n'
                      '• Prevent adaptation plateaus\n'
                      '• Optimize recovery between sessions\n'
                      '• Train multiple attributes simultaneously\n'
                      '• Reduce training monotony\n\n'
                      'Perfect for intermediate to advanced lifters looking for faster strength gains.',
                      style: TextStyle(
                        fontSize: 12,
